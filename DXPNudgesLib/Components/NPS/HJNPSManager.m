...
//                }
          ...
          // 反馈
          [[HJNudgesManager sharedInstance] nudgesFeedBackWithNudgesId:_baseModel.nudgesId contactId:contactId score:self.resultNumber thumbResult:@"" options:@"" comments:comments feedbackDuration:duration];
