 ...
 */
@interface NdFMDBMigrationManager : NSObject
 ...
 */
@protocol NdFMDBMigrating <NSObject>
 ...
 */
@interface NdFMDBFileMigration : NSObject <NdFMDBMigrating>
 ...
 */
extern NSString *const NdFMDBMigrationManagerErrorDomain;
 ...
 */
extern NSString *const NdFMDBMigrationManagerProgressVersionUserInfoKey;
...
/**
 ...
 @see `migrateDatabase:error:`
 */
extern NSString *const NdFMDBMigrationManagerProgressMigrationUserInfoKey;

/**
 @abstract Enumerates the errors returned by FMDBMigrationManager
 */
typedef NS_ENUM(NSUInteger, NdFMDBMigrationManagerError) {
